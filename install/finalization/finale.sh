...
if [ -f ~/.local/state/ohmydebn ]; then
  ...
  /usr/share/ohmydebn/bin/ohmydebn-headline "cat" "OhMyDebn update complete - version: $VERSION"
else
  echo
  /usr/share/ohmydebn/bin/ohmydebn-headline "cat" "Installation complete!"
  echo
