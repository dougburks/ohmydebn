...
if [ ! -f $DISABLE_ALGIF ]; then
  /usr/share/ohmydebn/bin/ohmydebn-headline "Disabling algif_aead kernel module"
...
if [ ! -f $DISABLE_DIRTYFRAG ]; then
  /usr/share/ohmydebn/bin/ohmydebn-headline "Disabling esp4/esp6/rxrpc kernel modules"
